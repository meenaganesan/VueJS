    ...
    <div class="registerFormOuter">
      <div class="formDiv">
        ...
        <div class="form">
          <div class="inputDiv">
            ...
            <div>
              <input class="inputElement"
                ...
                v-model="name"
              />
              <div class="error" v-if="submitted && !$v.password.required">Name is required.</div>
            </div>  
          </div>
          <div class="inputDiv">
            <label>
          ...
          <button type="submit" class="submitButton" @click="registerUser">Submit</button>
        </div>
      </div>  
    </div>  
  </div>
...
export default {
  ...
  methods: {
    registerUser() {
      ...
      // POST API for register a new user
...
#registerForm .registerFormOuter {
  display: flex;
  height: inherit;
  align-items: center;
...
#registerForm .inputElement:focus {
  outline: none;
}
